...
class McqModelAdapter extends TypeAdapter<McqModel> {
  @override
  final int typeId = 0;

  @override
  McqModel read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, McqModel obj) {
    writer
      ..writeByte(11)
      ..writeByte(0)
      ..write(obj.uniqueId)
